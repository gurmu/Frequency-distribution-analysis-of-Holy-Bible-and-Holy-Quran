...
async def create_callback_queue(request: CallbackQueueRequest):
    ...
    try:
        # Make API call to NICE inContact
        # Note: Adjust the endpoint based on your NICE inContact API version
        endpoint = "incontactAPI/services/v33.0/contacts/callback"
